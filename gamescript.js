        ...
        while (isFight && (opponentBoxer.currentHp > 0 || playerBoxer.currentHp > 0)) {
            ...
            while (fightOpt !== 'j' && fightOpt !== 'h' && fightOpt !== 'u') { // Fight Options routes
                ...
                if (fightOpt === 'j') {
                    ...
                    var damage = Math.floor(jab);
                    opponentBoxer.currentHp -= damage;
                    console.log("You quickly jab ".concat(opponentBoxer.firstName, " and hit them for ").concat(damage, "."));
                }
                    ...
                    if (hitChance >= 1 && hitChance <= 3) {
                        console.log("You go for an uppercut, but ".concat(opponentBoxer, " dodges and you miss."));
                    }
